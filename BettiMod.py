...
def train_and_evaluate(clf, X_train, X_test, y_train, y_test,list_of_exp_details, results_save="C:\\Users\\micha\\PycharmProjects\\betti\\cloud_data\\results\\results.csv"):
